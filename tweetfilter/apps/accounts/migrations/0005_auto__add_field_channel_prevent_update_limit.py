...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channel.prevent_update_limit'
        db.add_column(u'accounts_channel', 'prevent_update_limit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.prevent_update_limit'
        db.delete_column(u'accounts_channel', 'prevent_update_limit')
