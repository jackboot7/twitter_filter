...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'accounts', ['Trigger'])

        # Adding model 'Filter'
        db.create_table(u'accounts_filter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ...
        db.send_create_signal(u'accounts', ['Filter'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_trigger')

        # Deleting model 'Filter'
        db.delete_table(u'accounts_filter')
