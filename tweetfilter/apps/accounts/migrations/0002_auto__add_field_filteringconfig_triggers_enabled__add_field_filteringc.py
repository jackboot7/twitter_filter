...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilteringConfig.triggers_enabled'
        db.add_column(u'accounts_filteringconfig', 'triggers_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FilteringConfig.replacements_enabled'
        db.add_column(u'accounts_filteringconfig', 'replacements_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FilteringConfig.filters_enabled'
        db.add_column(u'accounts_filteringconfig', 'filters_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FilteringConfig.scheduleblocks_enabled'
        db.add_column(u'accounts_filteringconfig', 'scheduleblocks_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'FilteringConfig.blacklist_enabled'
        db.add_column(u'accounts_filteringconfig', 'blacklist_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilteringConfig.triggers_enabled'
        db.delete_column(u'accounts_filteringconfig', 'triggers_enabled')

        # Deleting field 'FilteringConfig.replacements_enabled'
        db.delete_column(u'accounts_filteringconfig', 'replacements_enabled')

        # Deleting field 'FilteringConfig.filters_enabled'
        db.delete_column(u'accounts_filteringconfig', 'filters_enabled')

        # Deleting field 'FilteringConfig.scheduleblocks_enabled'
        db.delete_column(u'accounts_filteringconfig', 'scheduleblocks_enabled')

        # Deleting field 'FilteringConfig.blacklist_enabled'
        db.delete_column(u'accounts_filteringconfig', 'blacklist_enabled')
