...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagAdvertisement.count'
        db.add_column(u'hashtags_hashtagadvertisement', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagAdvertisement.count'
        db.delete_column(u'hashtags_hashtagadvertisement', 'count')
