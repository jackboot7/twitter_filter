...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagAdvertisement.status'
        db.add_column(u'hashtags_hashtagadvertisement', 'status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagAdvertisement.status'
        db.delete_column(u'hashtags_hashtagadvertisement', 'status')
