...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagAdvertisement.channel'
        db.add_column(u'hashtags_hashtagadvertisement', 'channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Channel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagAdvertisement.channel'
        db.delete_column(u'hashtags_hashtagadvertisement', 'channel_id')
