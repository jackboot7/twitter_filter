...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagAdvertisement.enabled'
        db.add_column(u'hashtags_hashtagadvertisement', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagAdvertisement.enabled'
        db.delete_column(u'hashtags_hashtagadvertisement', 'enabled')
