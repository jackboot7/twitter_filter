...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagAdvertisement.start_date'
        db.add_column(u'hashtags_hashtagadvertisement', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HashtagAdvertisement.end_date'
        db.add_column(u'hashtags_hashtagadvertisement', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagAdvertisement.start_date'
        db.delete_column(u'hashtags_hashtagadvertisement', 'start_date')

        # Deleting field 'HashtagAdvertisement.end_date'
        db.delete_column(u'hashtags_hashtagadvertisement', 'end_date')
