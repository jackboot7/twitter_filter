...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'filtering_hashtagadvertisement', (
        ...
        db.send_create_signal(u'filtering', ['HashtagAdvertisement'])


    def backwards(self, orm):
        # Deleting model 'HashtagAdvertisement'
        db.delete_table(u'filtering_hashtagadvertisement')
    ...
    models = {
        ...
        u'filtering.hashtagadvertisement': {
