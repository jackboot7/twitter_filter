...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Keyword.enabled_mentions'
        db.add_column(u'filtering_keyword', 'enabled_mentions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Keyword.enabled_dm'
        db.add_column(u'filtering_keyword', 'enabled_dm',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Trigger.enabled_mentions'
        db.delete_column(u'filtering_trigger', 'enabled_mentions')

        # Deleting field 'Trigger.enabled_dm'
        db.delete_column(u'filtering_trigger', 'enabled_dm')

        # Deleting field 'Filter.enabled_mentions'
        db.delete_column(u'filtering_filter', 'enabled_mentions')

        # Deleting field 'Filter.enabled_dm'
        db.delete_column(u'filtering_filter', 'enabled_dm')


    def backwards(self, orm):
        # Deleting field 'Keyword.enabled_mentions'
        db.delete_column(u'filtering_keyword', 'enabled_mentions')

        # Deleting field 'Keyword.enabled_dm'
        db.delete_column(u'filtering_keyword', 'enabled_dm')

        # Adding field 'Trigger.enabled_mentions'
        db.add_column(u'filtering_trigger', 'enabled_mentions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Trigger.enabled_dm'
        db.add_column(u'filtering_trigger', 'enabled_dm',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Filter.enabled_mentions'
        db.add_column(u'filtering_filter', 'enabled_mentions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Filter.enabled_dm'
        db.add_column(u'filtering_filter', 'enabled_dm',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
